...
class CreateGoalUI extends StatefulWidget {
  final Person person;

  const CreateGoalUI({Key? key, required this.person}) : super(key: key);

  @override
  _CreateGoalUIState createState() => _CreateGoalUIState();
}

class _CreateGoalUIState extends State<CreateGoalUI> {
